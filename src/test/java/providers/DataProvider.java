...
public class DataProvider {
  ...
  public static Object[][] petCreationData() {
    ...
    PetDTO pet10 = new PetDTO(10, null, "", Arrays.asList(""), Arrays.asList(new PetTag(1, "tag 5")), "status");
    PetDTO pet11 = new PetDTO(11, null, null, null, null, null);
    return new Object[][]{{pet1}, {pet2}, {pet3}, {pet4}, {pet5}, {pet6}, {pet7}, {pet8}, {pet9}, {pet10}, {pet11}}
        ;
  }
  ...
  public static Object[][] petUpdateData() {
    PetDTO pet1 = new PetDTO(3, null, null, null, new ArrayList<PetTag>(), "null");
    PetDTO updatedPet1 = new PetDTO(4, new PetCategory(6, "category"), "m", Arrays.asList("updated url"), Arrays.asList(new PetTag(1, "tag 1 updated")), "status updated");
    return new Object[][]{{pet1, updatedPet1}}
        ;
  }
}
